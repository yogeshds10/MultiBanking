<%-- 
    Document   : passwd
    Created on : Apr 13, 2013, 7:02:32 PM
    Author     : client
--%>
...
<html>
    <head>
        ...
        <title>Change Password - Simple Multi-Banking</title>
    </head>
    <body>
        <div id="wrapper">
            <div id="header">
            ...
            <div id="content">
                ...
                <form action="PasswordHandler" method="post" class="singleform">
                    <h2>Change Password</h2>
                    <label>Current Password : </label>
                    <input type="password" name="cpasswd" id="cpasswd"/><br/><br/>
                    <label>New Password : </label>
                    <input type="password" name="npasswd" id="npasswd"/><br/><br/>
                    <label>Retype Password : </label>
                    <input type="password" name="rpasswd" id="rpasswd"/><br/><br/>
                    <div class="submit">
